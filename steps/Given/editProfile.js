...
const topNavigationPage = require("../../pageobjects/nav/top-navigation")
const { loginDefaultUser } = require("../../support/loginsupport")

Given(/a user has signed up and is on the preview page/, ()=>{
    loginDefaultUser()
    topNavigationPage.profile.click()
